...
// GraphicsLibTest
// ===============
// This is the TFT_eSPI graphics benchmark adapted to use:
// - TFT_eSPI
// - LovyanGFX
// - ArduinoGFX
// Select the library you want to test using the #define at the start
// of the code.
// ---------------------------------------------------------------------

// Choose the library you want to use here
#define _USE_TFT_ESPI
// #define _USE_LOVYAN
// #define _USE_ARDUINO

#ifdef _USE_TFT_ESPI
#include <TFT_eSPI.h>
#define _LIB_NAME "TFT_eSPI"
TFT_eSPI tft = TFT_eSPI();

#elif defined _USE_LOVYAN
#include <LovyanGFX.hpp>
#include "LovyanGFX_CYD_Settings.h"
#define _LIB_NAME "LovyanGFX"
LGFX tft;

#elif defined _USE_ARDUINO
#include <SPI.h>
#include <Adafruit_GFX.h>
#include <Adafruit_ILI9341.h>
#define _LIB_NAME "ArduinoGFX"
...
void setup() {
  Serial.begin(115200);
  delay(2000);
  Serial.printf("Starting test of the %s graphics library\n", _LIB_NAME);

  // Start the tft display and set it to black
#ifdef _USE_ARDUINO
  tft.begin();
  // For the Arduino we need to turn the sc reen on manually
  pinMode(21, OUTPUT);
