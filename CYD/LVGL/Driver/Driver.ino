...
// Driver
// ======
// This demonstrates how to use the LVGL library with a hand written
// display driver.
//----------------------------------------------------------------------
#include <driver/spi_common.h>
// This includes the stuff needed for SPI displays
#include <esp_lcd_io_spi.h>
// Include for basic LCD stuff
#include <esp_lcd_panel_dev.h>
// This is the include for our driver
...
//----------------------------------------------------------------------
static void BlitILI9341(lv_display_t* disp, const lv_area_t* area, uint8_t* px_map)
{
  ...
  panel_ili9341_draw_bitmap(panel_handle, area->x1, area->y1, area->x2 + 1, area->y2 + 1, px_map);
...
void setup() {
  Serial.begin(115200);
  delay(2000);
  Serial.println("Driver example started");
  ...
  // Initialise LVGL
  if (!InitLVGL((void*) ScrPanel, LCD_H_RES, LCD_V_RES, BlitILI9341)) {
