...
The NTP server code comes from [Andreas Spiess's YouTube video](https://www.youtube.com/watch?v=BGb2t5FT-zw). His github repository for this is [here](https://github.com/SensorsIot/NTP-Server-with-GPS/).
