...
This is a port of Dave Plummer's [drag race code](https://github.com/PlummersSoftwareLLC/Primes) to speed test processors. The code here is the [PrimeC solution 1 code](https://github.com/PlummersSoftwareLLC/Primes/tree/drag-race/PrimeC/solution_1).
